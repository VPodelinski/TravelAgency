...
public class GeneralMySQLRepository<T> implements GeneralRepository<T> {
    ...
    @Override
    public T save(final T t) throws HibernateException {
    ...
    @Override
    public T update(final T t) throws HibernateException {
        final Session session = getSession();
        session.update(t);
        return t;
    }
    ...
    @Override
    public T delete(final T t) throws HibernateException {
        final Session session = getSession();
        session.delete(t);
        return t;
    }
    ...
    @Override
    public T read(final long id, final Class<T> type) throws HibernateException {
        final Session session = getSession();
